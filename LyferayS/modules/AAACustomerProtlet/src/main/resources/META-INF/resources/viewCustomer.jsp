...
<liferay-ui:search-container emptyResultsMessage="customer-empty-results-message" 
	...
	<liferay-ui:search-container-results
		results="<%= CustomerLocalServiceUtil.getCustomersByGroupId(scopeGroupId,
	...
	>
		...
		/>
		<liferay-ui:search-container-column-text
			name="National_Id" property="national_Id"
		/>
		<liferay-ui:search-container-column-text
		...
		<% String serviceName = "";
			try {
				serviceName = yuvrajServicesLocalServiceUtil.getyuvrajServices
		...
		<liferay-ui:search-container-column-text
			name="Date" value="<%= sdf.format(customer.getStart_date()) %>"
		/>
		<liferay-ui:search-container-column-jsp
			align="right" path="/CustomerActions.jsp"
		/>
	</liferay-ui:search-container-row>

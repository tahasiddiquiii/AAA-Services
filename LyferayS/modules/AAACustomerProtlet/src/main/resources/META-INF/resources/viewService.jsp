...
<aui:button-row>
	<portlet:renderURL var="addServicesURL">
		<portlet:param name="mvcPath" value="/updateService.jsp" />
		<portlet:param name="redirect" value="<%= redirect %>" />
	</portlet:renderURL>

	<aui:button onClick="<%= addServicesURL.toString() %>" value="New Service" />
...
<liferay-ui:search-container total="<%=yuvrajServicesLocalServiceUtil.getServicesCountByGroupId(scopeGroupId)%>" >
	<liferay-ui:search-container-results
		results="<%=yuvrajServicesLocalServiceUtil.getServicesByGroupId(scopeGroupId, searchContainer.getStart(),
						searchContainer.getEnd())%>"
		/>

	<liferay-ui:search-container-row
		className="AAACustomerServices.model.yuvrajServices" keyProperty="serviceId"

...
public class CustomerLocalServiceImpl extends CustomerLocalServiceBaseImpl {
	...
	public Customer addCustomer(
	        long userId, long groupId, String name, String email, String address,
	        String national_Id, String contact,int month, int day, int year, 
	        int hour, int minute, long serviceId,
	        ServiceContext serviceContext)
	
	    throws PortalException, SystemException {
		
		System.out.println("Added Customer in the portal");
